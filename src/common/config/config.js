...
module.exports = {
  default_module: "api",
  weixin: {
    appid: "wx0da198e3246aa3fe", // 小程序 appid
    secret: "264e6a47bcdd75fd2d5ce211cede4bd6", // 小程序密钥
    mch_id: "", // 商户帐号ID
    partner_key: "", // 微信支付密钥
  ...
  qiniu: {
    access_key: "H69z0nAdI_-G4Dgg0gImSmxZunovyaY4xRFLW5-7", // 在七牛密钥管理中获取
    secret_key: "8P4nXwe5ckjtivTQa9dJ0p806CDxaJNHxz-dnK1_", // 在七牛密钥管理中获取
    bucket: "office-automation-system", // 请填自己的bucket的名称
    domain: "http://r9tekfe7i.hd-bkt.clouddn.com/", // 请填自己的domain域名
  },
  // 在七牛新建一个https的空间，这个是用来存储分享图片的https图片，对应的是goods表中的https_pic_url
  qiniuHttps: {
    access_key: "H69z0nAdI_-G4Dgg0gImSmxZunovyaY4xRFLW5-7", // 在七牛密钥管理中获取
    secret_key: "8P4nXwe5ckjtivTQa9dJ0p806CDxaJNHxz-dnK1_", // 在七牛密钥管理中获取
    bucket: "office-automation-system", // 自己设置的
    domain: "http://r9tekfe7i.hd-bkt.clouddn.com/", // 自己设置，例如：'http://img.你的域名.com/',别忘了这个”/“
